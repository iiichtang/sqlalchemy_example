...
if __name__ == "__main__":
    ...
    user_2 = User(name="test_user_2", birthday="2015-01-03", age="55", description="just a test")
    user_3 = User(name="test_user_1", birthday="2015-01-02", age="54", description="just a test")
    user_4 = User(name="test_user_2", birthday="2015-01-03", age="55", description="just a test")
    user_5 = User(name="test_user_1", birthday="2015-01-02", age="54", description="just a test")
    user_6 = User(name="test_user_2", birthday="2015-01-03", age="55", description="just a test")
    session.add(user_1)
    session.add(user_2)
    session.add(user_3)
    session.add(user_4)
